...
import "../../Standard Seater/Bus Layout/BusLayout.scss";
import { columnProps } from "../../../Types/types";
import VolvoSleeperLayout from "../SeatLayout/SeatLayout";

const VolvoSleeperBusLayout = () => {
...
export default VolvoSleeperBusLayout;
